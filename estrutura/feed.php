...
<body>
    <header class="header__interno" style="color:red;">
      <div class="container">
          <div class="container__logo">
            <a href="inicio.php"><img src="../imagens/logos/logo-principal.png" alt="Logo Principal do Ecogamma" class="container__logo__imagem"></a>
          </div>
            <nav class="container__nav">
                <a href="./perfil.php" class="container__nav__item">
                    <span class="material-symbols-outlined container__nav__menu__icone span--azul">&#xe853;</span>
                </a>
                <a href="./perfil.php" class="container__nav__item">
                    <span class="material-symbols-outlined container__nav__menu__icone span--azul">&#xe8af;</span>
                </a>
