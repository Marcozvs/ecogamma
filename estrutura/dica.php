  ...
  <section id="menuLateral__interno">
        <div class="container">
            ...
            <ul class="container__lista">
                ...
                <a href="./dica.php">
                    <li class="container__lista__item-ativo"><span class="material-symbols-outlined container__lista__item__icone-ativo  icone-alternativo">&#xe0f0;</span>Dicas</li>
                </a>
