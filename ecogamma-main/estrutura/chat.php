        ...
        <div class="container">
            ...
            <main class="principal">
                <div class="notificacoes">
                    <h1>Chat</h1>
                    <div class="notificacoes__notificacao">
                        <img src="./imagens/Roberta.jpg" alt="Imagem do perfil" class="notificacoes__notificacao__foto">
                        <div>
                            <p class="notificacoes__notificacao__nome">Roberta</p>
                            <p class="notificacoes__notificacao__mensagem">lorem cdsadca sadca sadca</p>
                        </div>
                    </div>
                    <div class="notificacoes__notificacao">
                        <img src="./imagens/Roberta.jpg" alt="Imagem do perfil" class="notificacoes__notificacao__foto">
                    ...
                    <form action="#">
                        <form action="#" class="cabecalho__pesquisa__formulario">
                            <input type="text" class="cabecalho__pesquisa__formulario__search" placeholder="Pesquise no Ecogamma" maxlength="30" minlength="1">
